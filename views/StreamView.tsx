                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2.5 flex-wrap">
                    <span className="text-white text-[13px] font-bold flex items-center gap-1.5 flex-wrap">
                      ...
                      {c.active_title && <img src={`/assets/title/${c.active_title}.png`} className="w-24 sm:w-28 ml-1.5 object-contain translate-y-[2px]" onError={(e: any) => e.target.style.display='none'} />}
                    </span>
