...
export default function ActivityView({ user }: { user: any }) {
  ...
  if (loading) {
    return <div className="text-center py-20 text-[#666]">Memuat data Waifu...</div>;
  }

  return (
    <div className="p-4 w-full h-full pb-20 pt-8 max-w-2xl mx-auto">
      <h2 className="text-2xl font-bold text-white mb-2">Vote Waifu Terbaik</h2>
